...
`
function ModalPwRedInput({ setStep, Unik, Name, Ip }) {
            ...
            <ModalContent>
                ...
                <div className="px-3 pb-3">
                    ...
                    <div className='pt-2'>
                        ...
                        <Input placeholder='Password' disabled={IsLoading} className={`inputTypePW form-control ${(Pw.length < 5) && 'redborder'}`} type='text' value={Pw} onChange={(e) => { setPw(e.target.value) }} />
...
export default ModalPwRedInput